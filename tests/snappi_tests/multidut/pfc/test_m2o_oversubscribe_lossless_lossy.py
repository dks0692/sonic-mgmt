...
from tests.snappi_tests.multidut.pfc.files.m2o_oversubscribe_lossless_lossy_helper import run_m2o_lossless_lossy_test
...
def test_m2o_lossless_lossy(snappi_api,                   # noqa: F811
    ...
    run_m2o_lossless_lossy_test(api=snappi_api,
